...
public class AppCenterDistributeListener implements DistributeListener {
    ...
    public boolean onReleaseAvailable(Activity activity, ReleaseDetails releaseDetails) {
        ...
        dialogBuilder.setTitle("New version available " + versionName +"!"); // you should use a string resource instead, this is just a simple example
...
//        Log.d("AppCenter", "No AppCenter updates available");
//    }
}